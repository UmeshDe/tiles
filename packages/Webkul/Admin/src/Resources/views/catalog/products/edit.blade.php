    ...
    <script>
        $(document).ready(function () {
            ...
            tinymce.init({
                ...
                toolbar1: 'formatselect | bold italic strikethrough forecolor backcolor| styleselect formatselect fontselect fontsizeselect | link | alignleft aligncenter alignright alignjustify | numlist bullist outdent indent  | removeformat | code | lists advlist',
                image_advtab: true
            });
        });
    </script>
